    ...
    private void btnDelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDelActionPerformed
        ...
        try {
            ...
            if (seletedRow >= 0) {
                ...
                int countRow = jNhanvienTable.getRowCount()-1;
                if (nhanvienToDel != null) {
                    ...
                    if (answer == JOptionPane.OK_OPTION) {
                     ...
                     if(countRow == 0 && seletedRow == 0){
                        JOptionPane.showMessageDialog(this, "Het du lieu");
                        return;
                    }
                    if(seletedRow != countRow){
                        jNhanvienTable.setRowSelectionInterval(seletedRow, seletedRow);
                        return;
                    } 
                    if (seletedRow == countRow) {
                        jNhanvienTable.setRowSelectionInterval(model.getRowCount() - 1, model.getRowCount() - 1);
                        return;
                    }
